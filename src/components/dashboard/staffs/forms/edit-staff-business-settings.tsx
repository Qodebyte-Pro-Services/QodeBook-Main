...
import { useStaffBusinessSettings, useUpdateStaffBusinessSettings } from "@/hooks/useControllers";
...
interface CreateStaffBusinessFormProps {
  ...
  businessId: number;
  branchId: number;
  data: StaffBusinessSettings | null;
}
...
function EditStaffBusinessForm({ onClose, branchId, businessId, data }: CreateStaffBusinessFormProps) {
  ...
  const staffBusinessSettingsHandler = useUpdateStaffBusinessSettings();
  ...
  async function onSubmit(data: FormValues) {
    ...
    try {
      ...
      await staffBusinessSettingsHandler.mutateAsync(payload, {
        onSuccess: (data) => {
          console.log(data);
          toast.success("Staff authentication settings Updated successfully");
          ...
          <div className="bg-gradient-to-r from-template-primary to-template-chart-store p-6 text-white">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold">Edit Staff Authentication Settings</h2>
              </div>
              <button 
                onClick={onClose}
...
export default EditStaffBusinessForm;