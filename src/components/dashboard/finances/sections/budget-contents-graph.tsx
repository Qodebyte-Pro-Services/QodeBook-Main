    ...
    return (
        <>
            <Card className="dark:bg-black">
                <CardHeader>
                    <div className="w-full flex flex-col md:flex-row justify-between gap-y-1.5 md:items-center">
                        <div className="flex flex-col gap-y-1">
                            <CardTitle>Budget Generated</CardTitle>
                            <CardDescription>Budget generated for a particular period</CardDescription>
                        </div>
                        <div className="flex items-center gap-x-2">
                            <div className="flex items-center gap-x-1">
                                <div className="w-3 h-3 rounded-[4px] bg-template-chart-store" />
                ...
                <CardContent>
                    <BudgetBarChart periodSelected={periodSelected} selectedDateRange={selectedDateRange} branchId={branchId} businessId={businessId} />
                </CardContent>
            </Card>
            {showDatePickerModal && (
...
export default BudgetContentGraph;